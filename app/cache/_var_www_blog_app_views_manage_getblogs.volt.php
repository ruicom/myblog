...
<div class="table-responsive">
    ...
    <nav>
        ...
        <?php if($page-1 > 0) {
        ?> 
          <li><a href="getBlogs?page=<?php echo $page-1 ?>">Previous</a></li>
        <?php } ?>
       <?php if($page+1 <= $totalpage) {
       ?> 
          <li><a href="getBlogs?page=<?php echo $page+1 ?>">Next</a></li>
        <?php } ?>
        </ul>
    </nav>
...
<script type="text/javascript">
    function upToOpen(id) {
        window.location = "upToOpen?id="+id; 
    }

    function downToPrivate(id) {
        window.location = "downToPrivate?id="+id; 
    }
