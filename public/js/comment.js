				...
				success:function(data){
					if(typeof(data.error)=="undefined"){
						...
						if(cmdata.parent_id == "0"){
						 ...
						 newli = "<li comment_id='"+data.id+"'><div ><div><img class='head-pic'  src='' alt=''></div><div class='cm'><div  class='cm-header'><span>"+data.nickname+"</span>&nbsp;<span>"+data.create_time+"</span></div><div class='cm-content'><p>"+data.content+"</p></div><div class='cm-footer'><a class='comment-delete' comment_id='"+data.id+"'  href='javascript:void(0);'>删除</a><a class='comment-reply' comment_id='"+data.id+"'  href='javascript:void(0);'>回复</a></div></div></div><ul class='children'></ul></li>";							
						 ...
						 //否则添加到对应的孩子ul列表中							 
                            ...
                            */
						 	newli = "<li comment_id='"+data.id+"'><div ><div><img class='head-pic'  src='' alt=''></div><div class='children-cm'><div  class='cm-header'><span>"+data.nickname+"</span><span>"+data.create_time+"</span></div><div class='cm-content'><p>"+data.content+"</p></div><div class='cm-footer'><a class='comment-delete' comment_id='"+data.id+"'  href='javascript:void(0);' replyswitch='off' >删除</a>&nbsp;<a class='comment-reply' comment_id='"+data.id+"'  href='javascript:void(0);' replyswitch='off' >回复</a></div></div></div><ul class='children'></ul></li>";
